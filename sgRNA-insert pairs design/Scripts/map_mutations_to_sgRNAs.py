...
def main():
    ...
    merged_oligos = pd.merge(sgRNA_df, mutations_df,
                             on=['gene', 'aa position', 'parent aa', 'mutated aa'], how='inner')
    ...
    if len(merged_oligos) == len(sgRNA_df):
        ...
        print("Not all sgRNAs are present in the mutations file. " \
        "The design needs to be adjusted. Please contact us for help.")
